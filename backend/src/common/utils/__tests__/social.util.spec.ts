...
describe('SocialUtil', () => {
  describe('identifyPlatform', () => {
    it('should identify GitHub URLs', () => {
      ...
      expect(SocialUtil.identifyPlatform('http://github.com/user')).toBe(
        PlatformEnum.GITHUB,
      );
      expect(SocialUtil.identifyPlatform('github.com/user')).toBe(
        PlatformEnum.GITHUB,
      );
      expect(SocialUtil.identifyPlatform('www.github.com/user')).toBe(
        PlatformEnum.GITHUB,
      );
      expect(SocialUtil.identifyPlatform('https://www.github.com/user')).toBe(
        PlatformEnum.GITHUB,
      );
      expect(SocialUtil.identifyPlatform('api.github.com')).toBe(
        PlatformEnum.GITHUB,
      );
    });
    ...
    it('should identify Twitter URLs', () => {
      ...
      expect(SocialUtil.identifyPlatform('www.twitter.com/user')).toBe(
        PlatformEnum.TWITTER,
      );
    });
    ...
    it('should identify X URLs', () => {
      ...
      expect(SocialUtil.identifyPlatform('www.x.com/user')).toBe(
        PlatformEnum.X,
      );
    });
    ...
    it('should return UNKNOWN for unrecognized URLs', () => {
      expect(SocialUtil.identifyPlatform('https://example.com')).toBe(
        PlatformEnum.UNKNOWN,
      );
      expect(SocialUtil.identifyPlatform('linkedin.com/user')).toBe(
        PlatformEnum.UNKNOWN,
      );
      expect(SocialUtil.identifyPlatform('invalid-url')).toBe(
        PlatformEnum.UNKNOWN,
      );
